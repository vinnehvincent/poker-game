...
import score.HandStrengthCalculator;

public class HandStrengthCalculatorTest {
	private HandStrengthCalculator scoreCalculator = new HandStrengthCalculator();
	...
	public void shouldReturnFlushScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand) == HandStrength.FLUSH);
	}
	@Test
	public void shouldReturnStraightHandScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.STRAIGHT));
	}
	@Test
	public void shouldReturnStraightFlushScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.STRAIGHT_FLUSH));
	}
	@Test
	public void shouldReturnFourOfAKindScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.FOUR_OF_A_KIND));
	}
	@Test
	public void shouldReturnHighCardScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.HIGH_CARD));
	}
	@Test
	public void shouldReturnThreeOfAKindScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.THREE_OF_A_KIND));
	}
	@Test
	public void shouldReturnOnePairScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.ONE_PAIR));
	}
	@Test
	public void shouldReturnTwoPairScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.TWO_PAIR));
	...
	public void shouldReturnFullHouseScore() {
		...
		assertTrue(scoreCalculator.determineHandStrength(hand).equals(HandStrength.FULL_HOUSE));
	}
}
