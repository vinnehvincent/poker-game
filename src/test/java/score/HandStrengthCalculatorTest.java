...
import scoring.rules.HandStrengthCalculator;
...
public class HandStrengthCalculatorTest {
	...
	public void shouldReturnFlushScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand) == HandStrength.FLUSH);
	}
	@Test
	public void shouldReturnStraightHandScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.STRAIGHT));
	}
	@Test
	public void shouldReturnStraightFlushScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.STRAIGHT_FLUSH));
	}
	@Test
	public void shouldReturnFourOfAKindScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.FOUR_OF_A_KIND));
	}
	@Test
	public void shouldReturnHighCardScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.HIGH_CARD));
	}
	@Test
	public void shouldReturnThreeOfAKindScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.THREE_OF_A_KIND));
	}
	@Test
	public void shouldReturnOnePairScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.ONE_PAIR));
	}
	@Test
	public void shouldReturnTwoPairScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.TWO_PAIR));
	...
	public void shouldReturnFullHouseScore() {
		...
		assertTrue(scoreCalculator.determineHandScore(hand).equals(HandStrength.FULL_HOUSE));
	}
}
